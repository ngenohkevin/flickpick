...
// ==========================================================================
// Movie Detail Page Error Boundary
// Handles errors when loading movie details
// ==========================================================================
...
export default function MovieError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logError(error, { component: 'MoviePage', action: 'loadDetails' });
  }, [error]);
  ...
  if (appError.code === 'NOT_FOUND') {
    return <ContentNotFound type="movie" />;
  }
